...
class Find_Primes2:
    ...
    which is worst than the first program's time complexity 
    ...
    in run time when compared to that of the first algorithm. In fact what was 
    seen was that for these test cases this algorithm computes it faster than the
    first implementation that has a better time complexity.
    """
